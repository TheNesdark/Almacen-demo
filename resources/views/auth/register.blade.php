        ...
        <div class="max-w-md w-full space-y-8">
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6 text-center">
                    ...
                    <p class="text-blue-100 mt-2">Únete a nosotros</p>
                </div>
                ...
                <div class="px-8 py-6">
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        <div class="text-center">
                            <p class="text-sm text-gray-600 mb-2">¿Ya tienes cuenta?</p>
                            <a href="{{ route('login') }}" class="inline-flex items-center text-blue-600 hover:text-blue-700 font-medium text-sm transition-colors duration-200">
