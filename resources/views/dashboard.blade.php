...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow duration-200">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600">Fabricantes</p>
                    <p class="text-3xl font-bold text-gray-900 mt-2">{{ App\Models\Fabricante::count() }}</p>
                </div>
            ...
            <div class="mt-4">
                <a href="{{ route('fabricantes.index') }}" class="inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-700">
                    Ver todos
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <a href="{{ route('fabricantes.index') }}" class="flex items-center justify-center px-4 py-3 border border-blue-300 rounded-lg text-blue-700 hover:bg-blue-50 hover:border-blue-400 transition-colors duration-200 group">
